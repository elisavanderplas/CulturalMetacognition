...
addpath(['~' fs 'Dropbox' fs 'PKU_collaboration' fs 'Github' fs 'tools' fs 'Corr_toolbox_v2']); 
addpath(['~' fs 'Dropbox' fs 'PKU_collaboration' fs 'Github' fs 'tools' fs 'Corr_toolbox_v2' fs 'LIBRA']);
   
%load betas Exp 1, made in R with 'EXP1_ExtractSumStats.r 
baseDir1 = ['~' fs 'Dropbox' fs 'PKU_collaboration' fs 'Github' fs 'DATA' fs 'EXP1'] ;
cd(baseDir1);
